            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right"><a href="<?=site_url('departement/depart/add')?>" class="btn btn-primary">Tambah</a></div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; foreach($depart as $row) {?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$row->name?></td>
                                    <td><a class="btn btn-info btn-xs" href="<?=site_url('departement/depart/sub/'.$row->id)?>">Add</a></td>
                                    <td>
                                        <a class="btn btn-success btn-xs" href="<?=site_url('departement/depart/update/'.$row->id)?>">Edit</a>
...
<input type="hidden" id="url" value="<?=site_url('departement/depart/delete/')?>">
