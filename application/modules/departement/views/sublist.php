            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?=$sub_title?> <b><?=$name_depart?></b></h3>
                        <div class="pull-right"><a href="<?=site_url('departement/depart/subadd/'.$iddepart)?>" class="btn btn-primary">Tambah</a></div>
                        <div class="pull-right"><a href="<?=site_url('departement/depart/')?>" class="btn btn-warning">Kembali</a></div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; foreach($subdepart as $row) {?>
                                <tr>
                                    <td><?=$no++?></td>
                                    <td><?=$row->name?></td>
                                    <td>
                                        <a class="btn btn-success btn-xs" href="<?=site_url('departement/depart/subupdate/'.$iddepart.'/'.$row->id)?>">Edit</a>
...
<input type="hidden" id="url" value="<?=site_url('departement/depart/subdelete/')?>">
