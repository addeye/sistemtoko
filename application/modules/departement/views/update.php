        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" action="<?=site_url('departement/depart/do_update')?>" method="post">
                            <input type="hidden" name="id" value="<?=$depart->id?>">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Nama Departemen</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="name" placeholder="Nama Departemen" value="<?=$depart->name?>">
                                </div>
                            </div>
                            <div class="form-group">
