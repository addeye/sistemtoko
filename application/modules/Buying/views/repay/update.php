                        ...
                        <div class="box-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="number" value="<?=$return->number?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="supplier" class="form-control select2" required>
                                            ...
                                            <?php foreach($supplier as $sup) {?>
                                                <option value="<?=$sup->id?>" <?=$return->supp->id==$sup->id?'selected':''?> ><?=$sup->name?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="note" rows="6"><?=$return->note?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control datetimepicker2" name="date" value="<?=human_date($return->date)?>">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
